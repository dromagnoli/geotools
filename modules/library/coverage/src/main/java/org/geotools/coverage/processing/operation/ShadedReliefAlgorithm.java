...
public enum ShadedReliefAlgorithm {
     ...
     */
    public float getValue(double[] window, ShadedReliefAlgorithm.HillShadeParams params) {
    ...
    static abstract class DataProcessor {
        ...
        ShadedReliefAlgorithm.HillShadeParams params;

        public DataProcessor (boolean hasNoData, Range noData, double noDataDouble, ShadedReliefAlgorithm algorithm, ShadedReliefAlgorithm.HillShadeParams params) {
    ...
    static class DataProcessorShort extends DataProcessor {
        short[] srcDataShort;
        public DataProcessorShort(short[] data, boolean hasNoData, Range noData, double noDataDouble, ShadedReliefAlgorithm algorithm, ShadedReliefAlgorithm.HillShadeParams params) {
            super(hasNoData, noData, noDataDouble, algorithm, params);
            srcDataShort = data;
        }
        @Override
    ...
    static class DataProcessorInt extends DataProcessor {
        int[] srcDataInt;
        public DataProcessorInt(int[] data, boolean hasNoData, Range noData, double noDataDouble, ShadedReliefAlgorithm algorithm, ShadedReliefAlgorithm.HillShadeParams params) {
            super(hasNoData, noData, noDataDouble, algorithm, params);
            srcDataInt = data;
        }
        @Override
    ...
    static class HillShadeParams {
        public HillShadeParams(double resX, double resY, double zetaFactor, double scale,
