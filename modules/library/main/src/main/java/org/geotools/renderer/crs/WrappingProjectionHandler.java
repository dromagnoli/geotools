...
public class WrappingProjectionHandler extends ProjectionHandler {
    ...
    public static final String DATELINE_WRAPPING_GLOBAL_OBJECTS_EXCLUSION = "datelineWrappingGlobalObjectsExclusion";
    ...
    public Geometry postProcess(MathTransform mt, Geometry geometry) {
        ...
        final boolean wrapExcludingGlobalObject =
                (excludeGlobalObjectsEnabled && width > targetHalfCircle && width <= targetHalfCircle * 2);
