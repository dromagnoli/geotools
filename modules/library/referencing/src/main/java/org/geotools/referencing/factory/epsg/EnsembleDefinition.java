...
class EnsembleDefinition {
        ...
        public EnsembleDefinition(String name, String code, String ellipsoidCode, String primeMeridianCode, String identifierAuthority, String datumCode, boolean vertical) {
            this.name = name;
            this.code = code;
    ...
    static {
        ...
        EnsembleDefinition wgs84 = new EnsembleDefinition("World Geodetic System 1984", "6326", "7030", "8901", "6326", "1155" , false);
        ENSEMBLE_MAP_BY_NAME.put(wgs84.getName(), wgs84);
        ENSEMBLE_MAP_BY_CODE.put(wgs84.getCode(), wgs84);

        EnsembleDefinition etrs89 = new EnsembleDefinition("European Terrestrial Reference System 1989", "6258", "7019", "8901", "6258", "1178" , false);
        ENSEMBLE_MAP_BY_NAME.put(etrs89.getName(), etrs89);
        ENSEMBLE_MAP_BY_CODE.put(etrs89.getCode(), etrs89);

        EnsembleDefinition dvr90 = new EnsembleDefinition("European Terrestrial Reference System 1989", "1371", null, null, "5206", null , true);
