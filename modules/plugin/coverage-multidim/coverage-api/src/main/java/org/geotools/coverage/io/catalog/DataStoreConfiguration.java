 ...
 * used to create that datastore, as well as the datastore connections
 * parameters. In the beginning, Multidim coverages was olding granules index 
 * within an H2 database for each NetCDF/GRIB file.
 * 
 * Latelly, it is also possible to deal with a PostGIS DB to be shared across 
 * different readers/files.
...
public class DataStoreConfiguration {
    ...
    /**
     * a boolean stating whether the granules index is stored "the old way", which is using an internal H2 DB for each file
     */
