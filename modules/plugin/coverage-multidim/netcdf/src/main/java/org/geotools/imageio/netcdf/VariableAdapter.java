...
public class VariableAdapter extends CoverageSourceDescriptor {
    ...
    public void updateMapping(SimpleFeatureType indexSchema, List<DimensionDescriptor> descriptors)
            throws IOException {
        DimensionMapper mapper = reader.georeferencing.dimensionMapper;
    ...
    private void setOtherFeatureAttribute(SimpleFeature feature, Number verticalValue,
        ...
        if (!Double.isNaN(verticalValue.doubleValue())) {
            ...
            final String elevationCVName = reader.georeferencing.dimensionMapper.getDimension(NetCDFUtilities.ELEVATION_DIM);
    ...
    private String getTimeAttribute(CoordinateSystem cs) {
        ...
        String timeAttribute = reader.georeferencing.dimensionMapper.getDimension(name.toUpperCase());
        if (timeAttribute == null) {
            timeAttribute = reader.georeferencing.dimensionMapper.getDimension(NetCDFUtilities.TIME_DIM);
        }
